## Rules
- All code prioritizes readability, and functions adhere to the single responsibility principle.
- When adding new features, always maintain the style of the existing code.
